...
export const commentChannel = createChannel();
    ...
    try {
        ...
        if (parentId) {
            ...
            if (parent && parent.userId !== userId) {
                ...
                sendNotification(parent.userId, 'comment_reply', 'Новый ответ на ваш комментарий', `${authorName} ответил(а) на ваш комментарий`, video ? `/courses/${video.courseId}/video/${video.id}` : undefined).catch(() => { });
            }
        }
